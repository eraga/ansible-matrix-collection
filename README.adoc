...
* Matrix users (synapse server only via https://github.com/matrix-org/synapse/blob/develop/docs/admin_api/user_admin_api.rst[synapse admin api]):
** [x] register,
** [x] update,
** [x] deactivate.
* Matrix Rooms actions:
** [x] create;
** [x] update;
